      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
          ...
          <div className="card bg-emerald-50 border-emerald-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-emerald-600">Approved Users</p>
                <p className="text-2xl font-bold text-emerald-900">{stats.approvedUsers}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="card">
            ...
            <p className="text-gray-600 mb-4">Approve and manage testers and developers</p>
          ...
          <div className="card">
            <h3 className="text-lg font-heading font-semibold mb-4">Opportunity Management</h3>
            <p className="text-gray-600 mb-4">Assign testers and manage project status</p>
            <Link to="/admin/opportunities" className="btn-secondary w-full text-center block">
          ...
          <div className="card">
            ...
            <Link to="/admin/opportunities" className="btn-accent w-full text-center block">
              View Analytics
            </Link>
          </div>
        </div>
